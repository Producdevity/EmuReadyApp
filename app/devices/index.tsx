...
import { useDeviceBrands, useDevices } from '@/lib/api/hooks'
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 8 }}>
            ...
            {deviceBrands.map((brand: DeviceBrand) => (
              <TouchableOpacity
                ...
                style={{
                  backgroundColor:
                    selectedBrand === brand.id ? theme.colors.primary : theme.colors.surface,
                  paddingHorizontal: 16,
                  paddingVertical: 8,
                  borderRadius: 20,
                  marginRight: 8,
                  borderWidth: 1,
                  borderColor:
                    selectedBrand === brand.id ? theme.colors.primary : theme.colors.border,
                }}
              >
                <ThemedText
                  style={{
          ...
          {filteredDevices.length === 0 ? (
            ...
            <View style={{ padding: 16 }}>
              {filteredDevices.map((device: Device, index: number) => (
                <Animated.View key={device.id} entering={FadeInUp.delay(index * 50)}>
                  <TouchableOpacity
                  ...
                  >
                    <Card style={{ padding: 16 }}>
                      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        >
                          <IconSymbol name="iphone" size={24} color={theme.colors.primary} />
                        </View>
