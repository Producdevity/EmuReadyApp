...
export const listingsService = {
  getListings: (input: GetListingsInput) =>
    api.get<GetListingsResponse>('/trpc/mobile.getListings', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getFeaturedListings: () => api.get<Listing[]>('/trpc/mobile.getFeaturedListings'),

  getListingsByGame: (input: GetListingsByGameInput) =>
    api.get<Listing[]>('/trpc/mobile.getListingsByGame', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getListingById: (input: GetListingByIdInput) =>
    api.get<Listing | null>('/trpc/mobile.getListingById', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getUserListings: (input: GetUserListingsInput) =>
    api.get<Listing[]>('/trpc/mobile.getUserListings', {
      params: { input: JSON.stringify({ json: input }) },
    }),
...
export const gamesService = {
  getGames: (input: GetGamesInput) =>
    api.get<Game[]>('/trpc/mobile.getGames', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getPopularGames: () => api.get<Game[]>('/trpc/mobile.getPopularGames'),

  searchGames: (input: SearchGamesInput) =>
    api.get<Game[]>('/trpc/mobile.searchGames', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getGameById: (input: GetGameByIdInput) =>
    api.get<Game | null>('/trpc/mobile.getGameById', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  findSwitchTitleId: (input: { gameName: string }) =>
    api.get<string[]>('/trpc/mobile.games.findSwitchTitleId', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getBestSwitchTitleId: (input: { gameName: string }) =>
    api.get<string | null>('/trpc/mobile.games.getBestSwitchTitleId', {
      params: { input: JSON.stringify({ json: input }) },
    }),
...
export const appService = {
  getAppStats: () => api.get<AppStats>('/trpc/mobile.getAppStats'),

  getSystems: () => api.get<System[]>('/trpc/mobile.getSystems'),

  getPerformanceScales: () => api.get<PerformanceScale[]>('/trpc/mobile.getPerformanceScales'),

  getSearchSuggestions: (input: SearchSuggestionsInput) =>
    api.get<SearchSuggestion[]>('/trpc/mobile.getSearchSuggestions', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getTrustLevels: () => api.get<TrustLevel[]>('/trpc/mobile.getTrustLevels'),

  getEmulators: (input: GetEmulatorsInput) =>
    api.get<Emulator[]>('/trpc/mobile.getEmulators', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getDevices: (input: GetDevicesInput) =>
    api.get<Device[]>('/trpc/mobile.getDevices', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getDeviceBrands: () => api.get<DeviceBrand[]>('/trpc/mobile.getDeviceBrands'),

  getSocs: () => api.get<Soc[]>('/trpc/mobile.getSocs'),
}

// Comments
export const commentsService = {
  getListingComments: (input: GetListingCommentsInput) =>
    api.get<Comment[]>('/trpc/mobile.getListingComments', {
      params: { input: JSON.stringify({ json: input }) },
    }),
...
export const votesService = {
  ...
  getUserVote: (input: GetUserVoteInput) =>
    api.get<boolean | null>('/trpc/mobile.getUserVote', {
      params: { input: JSON.stringify({ json: input }) },
    }),
}
...
export const userService = {
  getUserById: (input: { id: string }) =>
    api.get<User | null>('/trpc/mobile.getUserById', {
      params: { input: JSON.stringify({ json: input }) },
    }),
}
...
export const preferencesService = {
  getUserPreferences: () => api.get<UserPreferences>('/trpc/mobile.getUserPreferences'),
  ...
  removeDevicePreference: (input: RemoveDevicePreferenceInput) =>
    api.post<{ success: boolean }>('/trpc/mobile.preferences.removeDevicePreference', {
      json: input,
    }),

  bulkUpdateDevicePreferences: (input: {
    preferences: { deviceId: string; preferred: boolean }[]
  }) =>
    api.post<UserPreferences>('/trpc/mobile.preferences.bulkUpdateDevicePreferences', {
      json: input,
    }),
  ...
  getUserProfile: (input?: GetUserProfileInput) =>
    api.get<UserProfile | null>('/trpc/mobile.preferences.getUserProfile', {
      params: input ? { input: JSON.stringify({ json: input }) } : {},
    }),
...
export const notificationsService = {
  getNotifications: (input: GetNotificationsInput) =>
    api.get<GetNotificationsResponse>('/trpc/mobile.notifications.getNotifications', {
      params: { input: JSON.stringify({ json: input }) },
    }),
  ...
  markNotificationAsRead: (input: MarkNotificationReadInput) =>
    api.post<{ success: boolean }>('/trpc/mobile.notifications.markNotificationAsRead', {
      json: input,
    }),

  markAllNotificationsAsRead: () =>
    api.post<{ success: boolean }>('/trpc/mobile.notifications.markAllNotificationsAsRead', {
      json: {},
    }),
}
...
export const developersService = {
  ...
  isVerifiedDeveloper: (input: IsVerifiedDeveloperInput) =>
    api.get<boolean>('/trpc/mobile.developers.isVerifiedDeveloper', {
      params: { input: JSON.stringify({ json: input }) },
    }),
  ...
  getListingVerifications: (input: GetListingVerificationsInput) =>
    api.get<ListingVerification[]>('/trpc/mobile.developers.getListingVerifications', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getMyVerifications: (input: GetMyVerificationsInput) =>
    api.get<GetMyVerificationsResponse>('/trpc/mobile.developers.getMyVerifications', {
      params: { input: JSON.stringify({ json: input }) },
    }),
}
...
export const trustService = {
  ...
  getUserTrustInfo: (input: { userId: string }) =>
    api.get<{ score: number; level: string }>('/trpc/mobile.trust.getUserTrustInfo', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getTrustLevels: () => api.get<TrustLevel[]>('/trpc/mobile.trust.getTrustLevels'),
}
...
export const pcListingsService = {
  getPcListings: (input?: {
    ...
    }>('/trpc/mobile.pcListings.getPcListings', {
      params: input ? { input: JSON.stringify({ json: input }) } : {},
    }),

  createPcListing: (input: {
    gameId: string
    cpuId: string
    gpuId: string
  ...
  getPcListingById: (input: { id: string }) =>
    api.get<any>('/trpc/mobile.pcListings.get', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getCpusForMobile: () => api.get<any[]>('/trpc/mobile.pcListings.getCpus'),

  getGpusForMobile: () => api.get<any[]>('/trpc/mobile.pcListings.getGpus'),
}
...
export const cpusService = {
  getCpus: (input?: { search?: string; page?: number; limit?: number; manufacturer?: string }) =>
    api.get<{
      cpus: any[]
      pagination: { page: number; limit: number; total: number; totalPages: number }
    }>('/trpc/mobile.cpus.get', {
      params: input ? { input: JSON.stringify({ json: input }) } : {},
    }),

  getCpuById: (input: { id: string }) =>
    api.get<any>('/trpc/mobile.cpus.getById', {
      params: { input: JSON.stringify({ json: input }) },
    }),
}
...
export const gpusService = {
  getGpus: (input?: { search?: string; page?: number; limit?: number; manufacturer?: string }) =>
    api.get<{
      gpus: any[]
      pagination: { page: number; limit: number; total: number; totalPages: number }
    }>('/trpc/mobile.gpus.get', {
      params: input ? { input: JSON.stringify({ json: input }) } : {},
    }),

  getGpuById: (input: { id: string }) =>
    api.get<any>('/trpc/mobile.gpus.getById', {
      params: { input: JSON.stringify({ json: input }) },
    }),
}
...
export const listingReportsService = {
  createReport: (input: { listingId: string; reason: string; description?: string }) =>
    api.post<{ success: boolean; message: string }>('/trpc/mobile.listingReports.create', {
      json: input,
    }),

  checkUserHasReports: () =>
    api.get<{ hasReports: boolean; reportCount: number }>(
      '/trpc/mobile.listingReports.checkUserHasReports',
    ),
}
...
export const rawgService = {
  searchGames: (input: { query: string; page?: number; pageSize?: number }) =>
    api.get<any>('/trpc/mobile.rawg.searchGames', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  searchGameImages: (input: { query: string; page?: number; pageSize?: number }) =>
    api.get<any>('/trpc/mobile.rawg.searchGameImages', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getGameImages: (input: { gameId: string }) =>
    api.get<any>('/trpc/mobile.rawg.getGameImages', {
      params: { input: JSON.stringify({ json: input }) },
    }),
}
...
export const tgdbService = {
  searchGames: (input: { name: string; platform?: string }) =>
    api.get<any>('/trpc/mobile.tgdb.searchGames', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  searchGameImages: (input: { name: string; platform?: string }) =>
    api.get<any>('/trpc/mobile.tgdb.searchGameImages', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getGameImages: (input: { gameId: string }) =>
    api.get<any>('/trpc/mobile.tgdb.getGameImages', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getGameImageUrls: (input: { gameId: string }) =>
    api.get<any>('/trpc/mobile.tgdb.getGameImageUrls', {
      params: { input: JSON.stringify({ json: input }) },
    }),

  getPlatforms: () => api.get<any>('/trpc/mobile.tgdb.getPlatforms'),
}
